...
def _printInstructions(status, increment, sensor_output, test_theta, test_theta_a, test_phi, test_phi_a, probe_phi,
                       probe_phi_a, mcu_updated, laser_state, ambient_output, ambient_std):
...
def findAlignedPosition(MD_test, MD_probe):
    ...
    def printInstructions(status):
        _printInstructions(status, increment, sensor_output, test_theta, test_theta_a, test_phi, test_phi_a, probe_phi,
                           probe_phi_a, mcu_updated, laser_state, ambient_output, ambient_std)
...
if __name__ == "__main__":
    ...
    #         devices.append(dev)
    #
    # findAlignedPosition(devices[0], devices[0])